          ...
          <div className="space-y-4">
            {filteredNotifications.map((notification: Notification, index: number) => (
              <div 
                ...
                className={`group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-6 shadow-xl border border-white/30 dark:border-gray-700/30 transition-all duration-500 hover:scale-[1.01] hover:shadow-2xl transform ${
                  !notification.isRead ? 'ring-2 ring-purple-400/50 bg-gradient-to-r from-purple-50/80 to-pink-50/80 dark:from-purple-900/20 dark:to-pink-900/20' : ''
                }`}
                style={{ 
              ...
              >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className={`flex-shrink-0 p-3 rounded-2xl shadow-lg ${
                    notification.category === 'order' ? 'bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30' :
