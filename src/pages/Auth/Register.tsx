            ...
            >
              ...
              <label htmlFor="terms" className="text-sm text-gray-300">
                ...
                <button
                  ...
                  className="font-medium text-orange-500 hover:text-orange-400 transition-colors duration-200 underline"
                >
                  Terms of Service
                </button>{' '}
                and{' '}
      ...
      {showTermsModal && (
        ...
        >
          <motion.div
            ...
            className="bg-[#1a1d29] rounded-lg p-6 max-w-2xl max-h-[80vh] overflow-y-auto"
          ...
          >
            ...
            <div className="text-gray-300 space-y-4">
              <h3 className="font-semibold text-orange-500">1. Acceptance of Terms</h3>
              <p>By accessing and using ToolLink, you accept and agree to be bound by the terms and provision of this agreement.</p>

              <h3 className="font-semibold text-orange-500">2. Service Description</h3>
              <p>ToolLink is an online system designed to manage scheduled delivery orders and inventory for construction materials. We provide features for order management, warehouse coordination, and delivery scheduling.</p>

              <h3 className="font-semibold text-orange-500">3. User Responsibilities</h3>
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Respect the terms and conditions of deliveries and warehouse operations</li>
              </ul>

              <h3 className="font-semibold text-orange-500">4. Payment and Billing</h3>
              <p>Users agree to pay all applicable charges (if introduced) incurred through the platform. All payments will be processed securely through authorized payment partners.</p>

              <h3 className="font-semibold text-orange-500">5. Limitation of Liability</h3>
              <p>ToolLink shall not be liable for any indirect, incidental, special, or consequential damages arising from the use of our services, including but not limited to delays in delivery or stock shortages.</p>

              <h3 className="font-semibold text-orange-500">6. Termination</h3>
              <p>We reserve the right to suspend or terminate accounts that violate these terms or engage in fraudulent or unauthorized activities.</p>
            </div>
      ...
      {showPrivacyModal && (
        ...
        >
          ...
          >
            ...
            <div className="text-gray-300 space-y-4">
              <h3 className="font-semibold text-orange-500">1. Information We Collect</h3>
              ...
              <h3 className="font-semibold text-orange-500">2. How We Use Your Information</h3>
              <ul className="list-disc list-inside space-y-2">
              ...
              <h3 className="font-semibold text-orange-500">3. Information Sharing</h3>
              <p>We do not sell, trade, or otherwise transfer your personal information to third parties without your consent, except as described in this policy. Data may be shared with warehouses and delivery partners when required.</p>

              <h3 className="font-semibold text-orange-500">4. Data Security</h3>
              <p>We implement appropriate security measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction.</p>

              <h3 className="font-semibold text-orange-500">5. Cookies and Tracking</h3>
              <p>We use cookies and similar tracking technologies to enhance your experience and gather information about how you use our services.</p>

              <h3 className="font-semibold text-orange-500">6. Your Rights</h3>
              ...
              <h3 className="font-semibold text-orange-500">7. Contact Information</h3>
              <p>If you have any questions about this Privacy Policy, please contact us at toollinksrilanka@gmail.com</p>
            </div>
            <div className="mt-6 flex justify-end">
              <button
                onClick={() => setShowPrivacyModal(false)}
