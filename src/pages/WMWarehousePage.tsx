...
const WMWarehousePage: React.FC = () => {
    const { user } = useAuth();
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center">
                                ...
                                WM - Tools & Equipment Warehouse
                            </h1>
                            <p className="text-gray-600 dark:text-gray-300 mt-2">
                                Manage your tools, equipment, and machinery deliveries and sub-orders
                            </p>
                        </div>
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <div className="space-y-2">
                                                {subOrder.items.map((item) => (
                                                    <div key={item._id} className="flex justify-between items-center p-2 bg-green-50 dark:bg-green-900 rounded">
...
export default WMWarehousePage;
